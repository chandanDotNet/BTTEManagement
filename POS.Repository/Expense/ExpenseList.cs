            ...
            if (pageSize == 0)
            {
                var entities = await source
                    ...
                    .Select(cs => new ExpenseDto
                    {
                        ...
                        ExpenseApprovalStage=cs.ExpenseApprovalStage.Value,
                        AccountStatusFirstLevel=cs.AccountStatusFirstLevel,
                        AccountStatusRemarksFirstLevel=cs.AccountStatusRemarksFirstLevel,
                        ApprovedByFirstLevel=cs.ApprovedByFirstLevel.Value,
                        ReimbursementAmountFirstLevel  =   cs.ReimbursementAmountFirstLevel.Value,
                        ReimbursementRemarksFirstLevel= cs.ReimbursementRemarksFirstLevel,
                        ReimbursementStatusFirstLevel = cs.ReimbursementStatusFirstLevel,
                        AccountStatusRemarksSecondLevel=cs.AccountStatusRemarksSecondLevel,
                        AccountStatusSecondLevel=cs.AccountStatusSecondLevel,
                        ApprovedBySecondLevel=cs.ApprovedBySecondLevel.Value,
                        ReimbursementAmountSecondLevel =    cs.ReimbursementAmountSecondLevel.Value,
                        ReimbursementRemarksSecondLevel= cs.ReimbursementRemarksSecondLevel,
                        ReimbursementStatusSecondLevel = cs.ReimbursementStatusSecondLevel,
                        AccountStatusRemarksThirdLevel=cs.AccountStatusRemarksThirdLevel,
                        AccountStatusThirdLevel=cs.AccountStatusThirdLevel,
                        ApprovedByThirdLevel=cs.ApprovedByThirdLevel.Value,
